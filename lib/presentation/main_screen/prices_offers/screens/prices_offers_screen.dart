...
class PricesOffersScreen extends StatelessWidget {
  const PricesOffersScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: CommonAppBar(
            title: LocaleKeys.pricesOffers.tr(),
          )),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            BuildButtonWidget(
              txt: LocaleKeys.addRestrictions.tr(),
              darkGrey: false,
              onPressed: () {},
            ),
          ],
