        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(
                width: AppSize.size(context).width * 0.03,
              ),
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(titleTxt,
                        style: getBoldStyle(
                            fontSize: english == const Locale("en")
                                ? AppSize.size(context).width * .045
                                : AppSize.size(context).width * .042,
                    ...
                    Row(
                      ...
                      children: [
                        Text(subTitleTxt,
                            style: getBoldStyle(
                                fontSize: english == const Locale("en")
                                    ? AppSize.size(context).width * .035
                                    : AppSize.size(context).width * .042,
